...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/dialog/delType.css" type="text/css"></link>
    <script type="text/javascript" src="js/common/jquery-1.8.3.js"></script>
    <script type="text/javascript" src="js/dialog/delType.js"></script>
  </head>
  <body>
  	<div id="container" class="delType">
