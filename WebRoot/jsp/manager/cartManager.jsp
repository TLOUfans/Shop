...
<script type="text/javascript" src="js/cartManager.js"></script>
...
<body>
	<div id="container">
			...
			<table cellpadding="0" cellspacing="0" id="condition_table">
				<tr>
					<td class="condition_cell">
						<div style="width: 56px;" class="input_text" id="input_name">用户名</div>
					</td>
					...
					<td class="condition_cell">
						<div style="width: 56px;" class="input_text">商品名</div>
					</td>
					<td class="condition_cell_input">
						<div class="input_area">
		...
		<div id="list_bar">
			<div id="list_area_title">购物车列表</div>
