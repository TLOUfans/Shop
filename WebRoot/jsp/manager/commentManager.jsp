...
<script type="text/javascript" src="js/commentManager.js"></script>
...
<body>
	<div id="container">
			...
			<table cellpadding="0" cellspacing="0" id="condition_table">
				<tr>
					<td class="condition_cell">
						<div class="input_text" id="input_name">用户名</div>
					</td>
		...
		<div id="list_bar">
			<div id="list_area_title">评论列表</div>
