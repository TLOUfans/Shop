...
<link rel="stylesheet" href="css/typeManager.css" type="text/css"></link>
...
<script type="text/javascript" src="js/typeManager.js"></script>
...
<body>
	<div id="container">
			...
			<table cellpadding="0" cellspacing="0" id="condition_table">
				<tr>
					<td class="condition_cell">
						<div class="input_text" id="input_name">类型</div>
					</td>
					<td class="condition_cell_input">
						<div class="input_area">
							<input type="text" name="" id="type" class="text_control"
								placeholder="请输入类型名" />
						</div>
					</td>
					<td class="condition_cell">
						<div class="input_text">编号</div>
					</td>
					<td class="condition_cell_input">
		...
		<div id="list_bar">
			<div id="list_area_title">类型列表</div>
